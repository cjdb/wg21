...
1. Casey Carter, for reviewing all submissions to [cmcstl2][cmcstl2] and providing feedback that
   enabled the proposed range adaptors to have high-quality implementations.
2. Eric Niebler, for providing [range-v3][range-v3] as a reference implementation for the reference
   implementation.

## Motivation

[P0789][P0789] introduces the notion of a range adaptor and twelve pioneering range adaptors that
...
<table>
   ...
   <tr>
      <td>
         <a href="https://wandbox.org/permlink/7UXazMHnbxfOfODQ">Wandbox demo</a>
      </td>
      <td>
         <a href="https://wandbox.org/permlink/2nS3bzVuQX1DR0yJ">Wandbox demo</a>
      </td>
   </tr>
</table>
