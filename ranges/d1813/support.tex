...
\reviewernote{
  Should a type that models \placeholder{negatable} also model \tcode{totally_ordered}?
}
...
\reviewernote{
  If \placeholder{negatable} is refined to require \tcode{totally_ordered}, it stands to reason that
  \placeholder{differenceable-with} requires \tcode{totally_ordered_with}.
}
