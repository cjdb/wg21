...
\usepackage[pdftex,
            pdftitle={Changing the return types for ranges algorithms with alias return types},
            pdfsubject={Changing the return types for ranges algorithms with alias return types},
