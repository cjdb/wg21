...
I would like to thank  Simon Brand, Tom Honermann, Ruyman Reyes, Michael Wong, and Peter Žužek for
providing their feedback on this paper.
...
3. Exon Smith, D. _P0726R0 Does the Concepts TS Improve on C++17?_. 2017-07-07. Retrieved from:
   www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0726r0.html.
4. Honermann, T. _Refining Concepts: Improving error messages_. 2016-07-18. Date retrieved:
   2017-10-16. Retrieved from:
   http://honermann.net/blog/2016/07/18/refining-concepts-improving-error-messages.
5. Muller, J. _Implementation Challenge: Concepts in C++14_. 2017-09-09. Date retrieved: 2017-10-12.
   Retrieved from: http://foonathan.net/blog/2016/09/09/cpp14-concepts.html.
6. Stroustrup, B. _The C++ Programming Language_. Fourth edition. 2013.
   Addison-Wesley. Upper Saddle River, NJ.
7. Voutilainen, V. _P0225R0 Why I want Concepts, and why I want them sooner rather than later_.
   International Organization for Standardization. 2016-02-05. Date retrieved: 2017-10-16.
   Retrieved from: http://open-std.org/JTC1/SC22/WG21/docs/papers/2016/p0225r0.html.
8. Wolfram MathWorld. _Relation_. Date retrieved: 2017-10-06. Retrieved from:
   http://mathworld.wolfram.com/Relation.html.
9. Wolfram MathWorld. _Strict Order_. Date retrieved: 2017-10-06. Retrieved from:
